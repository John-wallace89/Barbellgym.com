"""
Functions to handle webhooks from Stripe
"""
...
class StripeWH_Handler:
    ...
    def _send_confirmation_email(self, order):
        ...
        subject = render_to_string(
            'checkout/confirmation_emails/order_received_subject.txt',
            {'order': order})
        body = render_to_string(
            'checkout/confirmation_emails/order_received_body.txt',
    ...
    def handle_event(self, event):
        """
        Handle a general webhook event
        """
        return HttpResponse(
